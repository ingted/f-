// This is a generated file; the original input is 'InteractiveDependencyManager.txt'
...
type internal SR private() =
    ...
    static let resources = lazy (new System.Resources.ResourceManager("InteractiveDependencyManager", getCurrentAssembly()))
